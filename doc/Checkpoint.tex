...
in C. Receiving SIGSEGV error every now and then was not pleasant to the eyes
and the mind. So we had to be very careful with how and when to allocate memory
and when to free it.

Also we found shift registers hard to implment in the assembler because of an
